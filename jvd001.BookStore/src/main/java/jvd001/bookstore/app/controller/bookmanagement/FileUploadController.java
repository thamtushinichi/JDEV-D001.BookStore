...
public class FileUploadController {
	 ...
	 */
	@RequestMapping(value = "bookmanagement/addbook/uploadFile", method = RequestMethod.POST)
	public @ResponseBody String uploadFileHandler(@RequestParam("image") String image, @RequestParam("file") MultipartFile file) {
		...
		if (!file.isEmpty()) {
			try {
				...
				return "You successfully uploaded file=" + image;
			} catch (Exception e) {
