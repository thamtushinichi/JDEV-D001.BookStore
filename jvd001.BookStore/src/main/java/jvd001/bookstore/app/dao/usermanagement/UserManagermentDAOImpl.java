...
public class UserManagermentDAOImpl implements UserManagermentDAO {

	private static final Logger logger = LoggerFactory.getLogger(UserManagermentDAOImpl.class);
