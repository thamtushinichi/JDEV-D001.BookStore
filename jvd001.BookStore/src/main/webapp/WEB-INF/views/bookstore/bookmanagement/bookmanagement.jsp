...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
	...
	<head>
		...
		<link href="<c:url value="/resources/css/bookmanagement/bookmanagemet.css" />" rel="stylesheet">
	...
	<!-- HEADER -->
		...
		<div class="container-fluid bg-3 text-center">
			<div class="row text-center">
				<div class="col-sm-3">
					<img src="./resources/images/kieu.jpg" class="image-responsive" alt ="No.1" width="60%" height="240"></br></br>
					<a href="#">Smith</a></br></br>
					<button id ="btnEdit1" type="button" class="btn btn-info">Edit</button>
					<button id ="btnDelete1" type="button" class="btn btn-danger" onclick="btnDelete(event)">Delete</button>
				</div>
				<div class="col-sm-3">
					<img src="./resources/images/kieu.jpg" class="image-responsive" alt ="No.2" width="60%"  height="240"></br></br>
